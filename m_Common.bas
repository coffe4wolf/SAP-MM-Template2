...
Function checkCommentExistsoInCell(Rng As Range) As Boolean

    If Trim(Rng.Comment) <> "" Then
        checkCommentExistsoInCell = True
    Else
        checkCommentExistsoInCell = False
    End If
    
End Function

Function ColumnLetter(ByRef Rng As Range)
...
Sub protectSheet(ws As Worksheet, password As String)
...
Sub unprotectSheet(ws As Worksheet, password As String)
